...
import com.fire.moon.springboot.domain.user.Role;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    /*
        ...
        -> autorizeRequests가 선언되어야만 antMatchers 옵션을 사용 할 수 있다.
        ...
        -> *BWMF20200807* 권한 신청 화면 만들어보기. 후에 배치로 MM일 이상 미 접속시 권한 강등 AP 만들어보자. 그 전에 Admin화면을 만들어야겠지 ?
        -> *BWMF20200807* 기본 회원가입 화면도 만들어보기. 로그인 타입 컬럼 생성 (ex: Google=1, Naver=2, 회원가입=0)

        .anyRequest
        -> 설정된 값들 이외 나머지 URL들을 나타냄.
        -> 여기서는 .authenticated()를 추가하여 나머지 URL들은 모두 인증된 사용자들에게만 허용하게 한다.
        -> 인증된 사용자 즉, 로그인한 사용자들을 야기함.
